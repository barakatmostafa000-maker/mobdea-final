...
const CORE_REGION_KEYS = ['egypt', 'arab', 'africa', 'asia', 'europe', 'world'];
const EXTRA_REGION_KEYS = ['northAmerica', 'southAmerica', 'australia'];
        ...
        <aside className="lesson-map-drawer lesson-map-drawer-controls">
          ...
          <div className="lesson-map-controls-scroll">
            <section className="lesson-map-control-section">
              ...
              <details className="lesson-map-extra-regions">
                <summary>خرائط إضافية</summary>
                <div>
                  {EXTRA_REGION_KEYS.map((key) => <button key={key} type="button" className={regionKey === key ? 'active' : ''} onClick={() => changeRegion(key)}>{GEOGRAPHY_REGIONS[key].title}</button>)}
                </div>
              </details>
            </section>
            <section className="lesson-map-control-section">
