...
const rawCards = [
  ...
  ['11', 'إثيوبيا', 'africa', 'أديس أبابا', 'الأمهرية وأورومو والصومالية والتيغرينية والعفرية'],
  ...
  ['28', 'الولايات المتحدة', 'americas-australia', 'واشنطن العاصمة', 'الإنجليزية'],
  ...
  ['35', 'نيوزيلندا', 'americas-australia', 'ويلينغتون', 'الإنجليزية والماورية ولغة الإشارة النيوزيلندية'],
];
...
export const COUNTRY_CARDS = Object.freeze(rawCards.map(([key, name, category, capital, language]) => ({
  key,
  name,
  category,
