        ...
        <div className="lesson-map-symbol-list">
          {activeGroup.items.map((item) => (
            <button
              ...
              onPointerDown={() => { setDrawTool('select'); setSelectedSymbol(item); }}
              onClick={() => { setDrawTool('select'); setSelectedSymbol(item); setToolsOpen(false); setNotice(`اختر موضع ${item.label} على الخريطة.`); }}
