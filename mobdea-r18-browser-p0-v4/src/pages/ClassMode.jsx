...
function resourceContentMode(resource) {
  ...
  const type = resource.type === 'textbook'
    ? 'textbook'
    : resource.type === 'exams'
      ? 'pdf'
      : inferMediaType({
...
function BoardThemeDecor({ template }) {
  ...
  return (
    <svg className={`classmode-board-theme-art theme-${template}`} viewBox="0 0 1200 720" preserveAspectRatio="none" aria-hidden="true">
      {template === 'history' && <>
        <defs>
          <linearGradient id="historyGold" x1="0" x2="1"><stop offset="0" stopColor="#5f3516"/><stop offset=".5" stopColor="#c69238"/><stop offset="1" stopColor="#5f3516"/></linearGradient>
        ...
        <rect x="18" y="18" width="1164" height="684" rx="18" fill="url(#papyrusFibres)" stroke="url(#historyGold)" strokeWidth="4" opacity=".5"/>
        <path d="M42 84h1116M42 650h1116" stroke="url(#historyGold)" strokeWidth="4" opacity=".34"/>
        <g fill="#6b421f" opacity=".16"><path d="M72 106h92l-9 18H81Zm14 18h64v360H86Zm-13 360h90l13 26H60Z"/><path d="M1036 106h92l-9 18h-74Zm14 18h64v360h-64Zm-13 360h90l13 26h-116Z"/></g>
        <g transform="translate(1015 185)" fill="none" stroke="#784719" opacity=".28"><ellipse rx="72" ry="40" strokeWidth="5"/><path d="M-46 0h92M0-34v68" strokeWidth="3"/><path d="M-82-54c28-18 136-18 164 0M-82 54c28 18 136 18 164 0" strokeWidth="4"/></g>
        <path d="M955 640 1080 405 1180 640ZM28 640 150 458 250 640Z" fill="#a87535" opacity=".14" stroke="#70421c" strokeWidth="4"/>
        <g fill="none" stroke="#70421c" strokeWidth="3" opacity=".15"><path d="M300 615c72-70 145-70 217 0s145 70 217 0 145-70 217 0"/><path d="M300 634c72-70 145-70 217 0s145 70 217 0 145-70 217 0"/></g>
        <g fill="#70421c" opacity=".16"><circle cx="310" cy="83" r="5"/><rect x="330" y="77" width="22" height="11" rx="2"/><path d="m372 88 12-20 12 20Z"/><circle cx="422" cy="82" r="8" fill="none" stroke="#70421c" strokeWidth="3"/></g>
      </>}
      {template === 'geography' && <>
